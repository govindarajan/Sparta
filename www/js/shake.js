//defines a variable named shae which is an object that deals with shakes
var shake = (function() {
    var shake = {},
        watchId = null,
        options = {
    ...
    function handleError() {
        console.log('Error happened while checking for shake corodova accelerometer shitted');
